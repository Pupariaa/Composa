...
export default class TemplateEngine {
    constructor(options = {}) {
        ...
        this.defaults = {
            ...
            COMMUNITY_GUIDELINES_URL: options.defaults?.COMMUNITY_GUIDELINES_URL || "https://example.com/community-guidelines",
    ...
    replaceVariables(template, variables = {}) {
        ...
        if (missing.length) {
            console.warn(`Warning: missing variables in template: ${missing.join(", ")}`);
        }
